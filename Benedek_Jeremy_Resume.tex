...
\begin{itemize}
    ...
    {\normalsize
      \begin{itemize}
          \resitem{Backend engineer working in the Supply Chain - Transportation area, using Kotlin, Spring Boot, Kafka, \& PostgreSQL}
              ...
              \resitem{Worked closely with business partners, engineering team, and leadership to develop attainable and high impact team goals for 2020}
    ...
    {IT Technician}{November 2014 -- June 2018}
    {\normalsize
      \begin{itemize}
...
\begin{itemize}
  ...
  %        \resitem{Studied abroad in Dominican Republic during Summer 2016 and Summer 2017}
